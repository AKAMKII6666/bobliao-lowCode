 ...
 * 传入参数
 */
export type ISpanProps = React.HTMLAttributes<HTMLSpanElement> & { children?: React.ReactNode | React.ReactNode[] | undefined | null; text: string | null };

//往外面暴露统一名称的属性对象，用于生成低代码平台属性JSON schema
export type Tinputprops = ISpanProps;

const Span: FC<ISpanProps> = (props): ReactElement => {
