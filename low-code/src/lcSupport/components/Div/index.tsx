 ...
 * 传入参数
 */
export type IDivProps = React.HTMLAttributes<HTMLDivElement> & { children?: React.ReactNode | React.ReactNode[] | undefined | null };

//往外面暴露统一名称的属性对象，用于生成低代码平台属性JSON schema
export type Tinputprops = IDivProps;

const Div: FC<IDivProps> = (props): ReactElement => {
