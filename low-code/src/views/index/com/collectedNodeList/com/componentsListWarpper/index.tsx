...
const ComponentListWarpper: FC<iprops> = ({ item }): ReactElement => {
	//===============useHooks=================
	...
	return (
		<>
			...
			>
				...
				>
					<ViewDayIcon className={styles.icon}></ViewDayIcon>
				</div>
				<Tooltip
					title={item.node.name + "-" + item.node.label}
					classes={{
						tooltip: styles.tip,
					}}
					followCursor={true}
...
export default memo(ComponentListWarpper);
